  ...
  const GetServics = async ()=>{
    ...
    return (
       <div className='w-[50%] h-[10vh] relative flex justify-center items-center ml-[10%] ' >
           ...
           <div className=' bg-zinc-100 absolute w-[50%] max-h-[50vh] top-[90%]  overflow-auto rounded' >
              {searches?.map((s,i)=>(
                <Link key={i} className=' hover:text-black hover:bg-zinc-200 duraton-200  font-semibold  w-[100%] p-5 flex justify-start items-center border-b-2 border-zinc-300 ' >
                 <img 
